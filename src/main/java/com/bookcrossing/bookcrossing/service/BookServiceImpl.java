...
public class BookServiceImpl implements BookService {
    ...
    public Book save(Book book) {
        if (book.getBCID() == null) {
            ...
            namedParameterJdbcTemplate.update("INSERT INTO book (bcid, Author, Title,Access, Status, Reader, Country, City, Street, House) VALUES (:bcid, :author, :title, :access, :status, '0000000003', 'Беларусь', 'Брест', 'Гоголя', '48')",
